...
import com.example.taskapp.SaveLocationSearchActivity;
...
public class GooglePlacesAutocompleteAdapterNew1 extends BaseAdapter {
    ...
    public GooglePlacesAutocompleteAdapterNew1(Context applicationContext, List<SaveLocationSearchActivity.placeModel> placeModels) {
